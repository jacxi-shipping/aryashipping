...
export default function Footer() {
  return (
    <footer className="relative z-10 border-t border-white/10 bg-[#020406] px-6 py-12 sm:px-12 lg:px-24">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-4">
        <div className="lg:col-span-2">
          <h3 className="text-2xl font-black uppercase tracking-widest text-white">Arya Shipping</h3>
      ...
      <div className="mx-auto mt-16 max-w-7xl border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-xs text-white/40">© 2026 Arya Shipping. All systems operational.</p>
        <div className="flex gap-4 text-xs font-bold text-white/40">
          ...
          <span className="hover:text-white transition-colors cursor-pointer">PS</span>
          <span className="hover:text-white transition-colors cursor-pointer">DR</span>
        </div>
      </div>
    </footer>
  );
