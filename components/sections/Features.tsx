...
const featureIcons = [ShipIcon, CraneIcon, TruckIcon, DocumentIcon];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {t.features.items.map((feature, i) => {
            const Icon = featureIcons[i] ?? ShipIcon;
            ...
            return (
              ...
              >
                <div className={`absolute -top-4 opacity-10 transition-transform group-hover:scale-110 group-hover:opacity-20 text-[#00a3ff] ${isRtl ? "-left-4" : "-right-4"}`}>
