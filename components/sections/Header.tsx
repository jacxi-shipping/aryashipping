...
export default function Header() {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 px-6 py-6 sm:px-12 lg:px-24 flex items-center justify-between">
      <div className="font-black text-xl tracking-tighter uppercase flex items-center gap-2">
        ...
        Arya<span className="text-[#00a3ff]">Shipping</span>
      </div>
