        ...
        <div>
          ...
          <div className="mt-12 grid grid-cols-2 gap-4">
            <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
              ...
              <div className="mt-2 text-sm text-white/60">Years Experience</div>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
              <div className="text-3xl font-black text-[#00a3ff]">24/7</div>
              <div className="mt-2 text-sm text-white/60">Command Center</div>
            </div>
          </div>
        </div>
        ...
        <form className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#0a1017]/80 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
          ...
          <div className="relative z-10 grid gap-6 sm:grid-cols-2">
            <label className="block space-y-2">
              <span className="text-xs font-bold uppercase tracking-widest text-white/60">Origin</span>
            ...
            <label className="block space-y-2">
              <span className="text-xs font-bold uppercase tracking-widest text-white/60">Destination</span>
              <input readOnly value="Afghanistan" className="w-full rounded-lg border border-white/10 bg-black/50 p-4 text-white/50 outline-none" />
            </label>
            <label className="block space-y-2 sm:col-span-2">
              <span className="text-xs font-bold uppercase tracking-widest text-white/60">Vehicle Link / VIN</span>
              <input placeholder="Paste Auction Link or VIN" className="w-full rounded-lg border border-white/10 bg-black/50 p-4 text-white outline-none transition-colors focus:border-[#00a3ff] focus:bg-black/80 placeholder:text-white/20" />
            </label>
